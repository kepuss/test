...
WebUI.setText(findTestObject('Page_oxAuth - Login (2)/input_loginFormusername'), 'michal')

WebUI.setText(findTestObject('Page_oxAuth - Login (2)/input_loginFormpassword'), 'secret')
...
WebUI.setText(findTestObject('Page_Gluu Gateway/input_form-control ng-untouche'), '/docs')
...
WebUI.setText(findTestObject('Page_Gluu Gateway (2)/input_path0'), '/new')
...
ticketRequest.setHttpBody(((('{"oxd_id":"' + uma_oxdid) + '","path":"/test","http_method":"GET","protection_access_token":"') + 
    umaAccessToken) + '"}')
